...
// @desc    Search for programmes (standalone)
`;

fileContent = fileContent.replace('// @desc    Search for programmes (standalone)', newEndpoint);
fs.writeFileSync('routes/resultEntryRoutes.js', fileContent);
console.log('Added dashboard-stats endpoint');
